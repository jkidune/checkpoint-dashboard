            ...
            <div key={m.id} className="card" style={{ cursor:'pointer', transition:'border-color 0.2s' }}
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:8, marginBottom:12 }}>
                <div style={{ background:'var(--bg-input)', borderRadius:8, padding:'8px 10px' }}>
                  <div style={{ color:'var(--text-muted)', fontSize:10 }}>2025 Contributions</div>
                  <div style={{ color:'var(--accent-blue)', fontWeight:700, fontSize:13 }}>{fmt(m.contributions_2025)}</div>
                </div>
                <div style={{ background:'var(--bg-input)', borderRadius:8, padding:'8px 10px' }}>
                  <div style={{ color:'var(--text-muted)', fontSize:10 }}>Cumulative</div>
        ...
        <Modal title="Add New Member" onClose={() => setShowAdd(false)}>
          <form onSubmit={handleAdd} className="modal-form">
            ...
            <div style={{ background:'var(--bg-input)', borderRadius:8, padding:'10px 14px', fontSize:12, color:'var(--text-muted)' }}>
              Entry fee of <strong style={{ color:'var(--accent-blue)' }}>TZS 100,000</strong> will be recorded automatically.
            </div>
